...
var EventSource, Events, File, HTML, History, JSDOM, Screen, URL, WebSocket, XMLHttpRequest, createDocument, createWindow, jsdomDispatchElement, loadDocument, nodeGlobal;
...
module.exports = createWindow = function(_arg) {
  ...
  window.postMessage = function(data, targetOrigin) {
    ...
    event.data = data;
    event.source = browser._windowInScope ? browser._windowInScope.getGlobal() : window;
